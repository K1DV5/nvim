...
let s:cdFront = {'gui': '#D4D4DF', 'cterm': s:cterm05, 'cterm256': '188'}
let s:cdBack = {'gui': '#1C1C1E', 'cterm': s:cterm00, 'cterm256': '234'}

let s:cdTabCurrent = {'gui': '#1C1C1E', 'cterm': s:cterm00, 'cterm256': '234'}
let s:cdTabOther = {'gui': '#2B2B2D', 'cterm': s:cterm01, 'cterm256': '236'}
let s:cdTabOutside = {'gui': '#232326', 'cterm': s:cterm01, 'cterm256': '235'}

let s:cdLeftDark = {'gui': '#232326', 'cterm': s:cterm01, 'cterm256': '235'}
let s:cdLeftMid = {'gui': '#373737', 'cterm': s:cterm03, 'cterm256': '237'}
let s:cdLeftLight = {'gui': '#3F3F46', 'cterm': s:cterm03, 'cterm256': '238'}

let s:cdPopupFront = {'gui': '#BABABB', 'cterm': s:cterm06, 'cterm256': '250'}
let s:cdPopupBack = {'gui': '#2B2B30', 'cterm': s:cterm01, 'cterm256': '236'}
let s:cdPopupHighlightBlue = {'gui': '#033255', 'cterm': s:cterm0D, 'cterm256': '24'}
let s:cdPopupHighlightGray = {'gui': '#3B3B40', 'cterm': s:cterm03, 'cterm256': '237'}
...
let s:cdBlue = {'gui': '#539AD6', 'cterm': s:cterm0D, 'cterm256': '75'}
let s:cdDarkBlue = {'gui': '#223E55', 'cterm': s:cterm0D, 'cterm256': '73'}
let s:cdLightBlue = {'gui': '#9CDCFF', 'cterm': s:cterm0C, 'cterm256': '117'}
if g:codedark_conservative | let s:cdLightBlue = s:cdFront | endif
let s:cdGreen = {'gui': '#6A9F55', 'cterm': s:cterm0B, 'cterm256': '65'}
let s:cdBlueGreen = {'gui': '#4EC9B0', 'cterm': s:cterm0F, 'cterm256': '43'}
let s:cdLightGreen = {'gui': '#B5CEA8', 'cterm': s:cterm09, 'cterm256': '151'}
let s:cdRed = {'gui': '#F44747', 'cterm': s:cterm08, 'cterm256': '203'}
let s:cdOrange = {'gui': '#D39478', 'cterm': s:cterm0F, 'cterm256': '173'}
...
call <sid>hi('DiffDelete', s:cdGray, s:cdDiffRedLight, 'none', {})
call <sid>hi('DiffText', {}, s:cdDarkBlue, 'none', {})
...
" JavaScript:
call <sid>hi('javaScriptOperator', s:cdBlue, {}, 'none', {})
call <sid>hi('javaScriptType', s:cdBlueGreen, {}, 'none', {})
call <sid>hi('javaScriptNull', s:cdBlue, {}, 'none', {})
call <sid>hi('javaScriptIdentifier', s:cdBlue, {}, 'none', {})
call <sid>hi('javaScriptMessage', s:cdLightBlue, {}, 'none', {})
call <sid>hi('javaScriptFunctionDef', s:cdBlue, {}, 'none', {})
...
" Signify:
" call <sid>hi('SignifySignAdd', {}, s:cdDiffGreenDark 'none', {})
call <sid>hi('SignifySignChange', {}, s:cdDarkBlue, 'none', {})
" call <sid>hi('SignifySignDelete', {}, s:cdRed, 'none', {})
highlight SignifySignChangeDelete guibg=#777700 ctermbg=550
" call <sid>hi('SignifySignDeleteFirstLine', {}, s:cdRed, 'none', {})
